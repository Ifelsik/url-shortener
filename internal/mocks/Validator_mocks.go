...
func (_mock *MockValidator) ValidateStruct(v any) error {
	ret := _mock.Called(v)
...
//   - v any
func (_e *MockValidator_Expecter) ValidateStruct(v interface{}) *MockValidator_ValidateStruct_Call {
	return &MockValidator_ValidateStruct_Call{Call: _e.mock.On("ValidateStruct", v)}
}

func (_c *MockValidator_ValidateStruct_Call) Run(run func(v any)) *MockValidator_ValidateStruct_Call {
...
func (_c *MockValidator_ValidateStruct_Call) RunAndReturn(run func(v any) error) *MockValidator_ValidateStruct_Call {
	_c.Call.Return(run)
	return _c
}
